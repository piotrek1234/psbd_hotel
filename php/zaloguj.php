...
if(isset($_POST['Zaloguj']))
{
  ...
  $query = "SELECT haslo, idPracownika, stanowisko, login FROM pracownicy WHERE login='$login'";
  ...
  if(md5($haslo) == $query_row['haslo'])
  {
    ...
    $_SESSION['idPracownika']=$query_row['idPracownika'];

    //header("Location: panel_klienta.php");
	switch($query_row['stanowisko'])
	{
		case 1:
			header('Location: glowna_recepcjonisty.php');
			break;
		case 2:
			header('Location: glowna_menagera.php');
			break;
		case 3:
			header('Location: glowna_szefa.php');
			break;
		case 4:
			header('Location: glowna_barmana.php');
			break;
	}
...
<body>
<?php require_once "naglowek_pracownik.php"; ?>
<div class="container">
